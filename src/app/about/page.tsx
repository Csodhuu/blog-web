...
const timeline = [
  {
    year: "2011",
    milestone: "Launched Gateway Sports Travel with our first basketball invitational in Manila, hosting five regional academies.",
  },
  {
    year: "2015",
    milestone:
  ...
  return (
    <div className="bg-gradient-to-b from-white via-slate-50 to-white">
      <section className="border-b border-slate-200 bg-white/80">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[2fr_1fr]">
            ...
            <div className="rounded-3xl border border-slate-200 bg-[url('https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=900&q=80')] bg-cover bg-center shadow-inner" aria-hidden />
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl space-y-4">
            <p className="text-sm font-semibold uppercase tracking-wide text-primary">Our Journey</p>
            <h2 className="text-2xl font-semibold text-slate-900 sm:text-3xl">Timeline of key moments</h2>
            <p className="text-sm text-slate-600">
              Strategic growth over the past decade has allowed us to broaden disciplines, destinations, and service depth while maintaining boutique attention to detail.
            </p>
          </div>
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {timeline.map((item) => (
              ...
              >
                ...
                <p className="mt-3 text-base font-medium text-slate-800">{item.milestone}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white/90">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl space-y-4">
            <p className="text-sm font-semibold uppercase tracking-wide text-primary">What we can do</p>
            <h2 className="text-2xl font-semibold text-slate-900 sm:text-3xl">
              Comprehensive travel, event, and visa execution
            </h2>
            <p className="text-sm text-slate-600">
              We partner with coaches, athletic directors, and guardians to deliver turnkey solutions that align with competitive calendars and academic priorities.
            </p>
          </div>
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {capabilities.map((capability) => (
              ...
              >
                <p className="text-base font-semibold text-slate-900">{capability.title}</p>
